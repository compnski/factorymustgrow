...
import { Lab, NewLab, ResearchInLab, ResearchOutput, setLabResearch } from "./research"
...
describe("Labs", () => {
  function TestLab(
    ...
    lab.outputBuffers = (lab.outputBuffers as ResearchOutput).SetResearch(lab.RecipeId, 0, 150)
