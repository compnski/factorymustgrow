...
import { MainBusController, MainBusControllerChildProps } from "./MainBusController"
...
export const FactoryGame = (props: ReturnType<typeof getDispatchFunc>) => {
  ...
  const [currentRegionId, setCurrentRegionId] = useState<string>(gameState.Regions.keys().next().value || "")
  ...
  useInterval(async () => {
    ...
    await UpdateGameState(gameState, { dispatch, executeActions }, tick, generalDialog)
  }, 1000 / TicksPerSecond)
    ...
    return (
      <div className="factory-game">
        ...
        <div style={{ display: "flex" }}>
          <InfoHeader currentRegion={currentRegion} researchState={researchState} />
        </div>
        <div className="scroller">
          <MainBusController region={currentRegion} uxDispatch={uxDispatch} gameState={gameState}>
            {({
              beltHandler,
              beltState,
              ghostConnection,
        ...
        <DebugButtonPanel researchState={researchState} uxDispatch={uxDispatch} />
