...
export const settingsValidator = Joi.object<Settings>({
  animatedEnabled: Joi.boolean().optional().default(defaultSettings.animatedEnabled),
  cloudSaveEnabled: Joi.boolean().optional().default(defaultSettings.cloudSaveEnabled),
  debugEnabled: Joi.boolean().optional().default(defaultSettings.debugEnabled),
  autosaveIntervalMin: Joi.number().min(0).optional().default(defaultSettings.autosaveIntervalMin),
  autosaveCount: Joi.number().min(0).optional().default(defaultSettings.autosaveCount),
